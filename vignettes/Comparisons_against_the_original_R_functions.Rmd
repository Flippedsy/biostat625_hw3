...
benchmark_gaussian <- bench::mark(
  M_gaussian = M_gaussian(Depression ~ Fatalism, data = data),
  glm_gaussian = glm(Depression ~ Fatalism, family = gaussian, data = data),
  iterations = 100
)
...
benchmark_poisson <- bench::mark(
  M_poisson = M_poisson(y ~ x, data = data_poisson),
  glm_poisson = glm(y ~ x, family = poisson, data = data_poisson),
  iterations = 100
)
